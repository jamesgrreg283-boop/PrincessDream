  ...
  return (
    <>
      <SEO
        ...
        description="Meet our magical fairytale entertainers — princesses, mermaids, snow queens and fairies. Book your favourite for parties in Coventry & Warwickshire."
        path="/characters"
      />
